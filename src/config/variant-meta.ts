...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    ...
    description: "Sid's real-time global intelligence dashboard with live news, markets, military tracking, infrastructure monitoring, and geopolitical data. OSINT in one view.",
    ...
    siteName: "Sid's World Monitor",
    shortName: "Sid's Monitor",
